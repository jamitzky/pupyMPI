...
## Every rank puts in an A at own index - A is 'smaller' than the other letters
#ba[rank] = b'A'
#result2 = world.reduce(ba, MPI_min)
#
#if rank == root:
...
#result3 = world.reduce(bo, MPI_min)
#if rank == root:
...
#result4 = world.reduce(r, MPI_min)
#if rank == root:
...
#result5 = world.reduce(tu, MPI_min)
#if rank == root:
...
##print se
##
##result6 = world.reduce(se, MPI_min)
##print result6
