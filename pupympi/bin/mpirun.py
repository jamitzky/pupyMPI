...
def parse_options():
    ...
    parser_adv_group.add_option('--force-select', dest='force_select', action='store_true', default=False, help="Forces the use of select() network call instead of either epoll (on linux) or kqueue (on BSD). Non Linux/BSD platforms will always fall back to select().")
...
if __name__ == "__main__":
    ...
    if options.force_select:
        global_run_options.append('--force-select')
